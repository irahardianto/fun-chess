...
const hookFens = [
  '7k/R5p1/5N2/6P1/8/8/8/6K1 w - - 0 1',
  '7k/R5p1/5N2/6P1/8/8/8/5K2 w - - 0 1',
  '7k/R5p1/5N2/6P1/8/8/8/4K3 w - - 0 1',
  '7k/R5p1/5N2/6P1/8/8/8/3K4 w - - 0 1',
  '7k/R5p1/5N2/6P1/8/8/8/2K5 w - - 0 1',
  '7k/R5p1/5N2/6P1/8/8/8/1K6 w - - 0 1',
  '7k/R5p1/5N2/6P1/8/8/8/K7 w - - 0 1',
  '7k/R5p1/5N2/6P1/8/8/7P/6K1 w - - 0 1',
  '7k/R5p1/5N2/6P1/8/8/6PP/6K1 w - - 0 1',
  '7k/R5p1/5N2/6P1/8/8/5PPP/6K1 w - - 0 1',
  '7k/R5p1/5N2/6P1/8/8/8/6K1 w - - 0 1',
  '7k/R5p1/5N2/6P1/8/8/8/6K1 w - - 0 1',
  '7k/R5p1/5N2/6P1/8/8/8/6K1 w - - 0 1',
  '7k/R5p1/5N2/6P1/8/8/8/6K1 w - - 0 1',
...
hookFens.forEach((fen, idx) => {
  ...
  DEFLECTION_DECOY.push(makeTactic({
    ...
    subtitle: 'Ra8# delivers checkmate supported by f6 Knight!',
    playerColor: 'w',
    tacticalGoal: 'Deliver Ra8# checkmate.',
    tacticalReward: 'checkmate',
    outcomeAdvantage: 'Checkmate 👑',
    learningSummary: '1. Ra8# delivered checkmate supported by the f6 Knight.',
...
const ggFens = [
  ...
  'r1bq1rk1/pppn1ppp/4p3/4P3/3P4/2NB1N2/PPP2PPP/R2QK2R w KQ - 0 1',
  'r1bq1rk1/pppn1ppp/4p3/4P3/3P4/2NB1N2/PPP2PPP/R1BQK2R w KQ - 0 1',
  'r1bq1rk1/pppn1ppp/4p3/4P3/3P4/2NB1N2/PPP2PPP/R1BQK2R w - - 0 1',
  'r1bq1rk1/pppn1ppp/4p3/4P3/3P4/2NB1N2/PPP2PPP/R1BQK2R w KQ - 0 1',
  'r1bq1rk1/pppn1ppp/4p3/4P3/3P4/2NB1N2/PPP2PPP/R1BQK2R w KQ - 0 1',
...
ggFens.forEach((fen, idx) => {
  ...
  GREEK_GIFT.push(makeTactic({
    id: `puz_greekgift_${num}`,
    fen,
    moves: ['d3h7', 'g8h7', 'f3g5', 'h7g8', 'd1h5', 'd8g5', 'h5g5'],
    rating: 1650 + idx * 35,
...
const wmFens = [
  ...
  'r2q1rk1/ppp2ppp/5B2/8/8/8/5P1P/6RK w - - 0 1',
  'r2q1rk1/ppp2ppp/5B2/8/8/8/4P2P/6RK w - - 0 1',
  'r2q1rk1/ppp2ppp/5B2/8/8/8/3P3P/6RK w - - 0 1',
  'r2q1rk1/ppp2ppp/5B2/8/8/8/2P4P/6RK w - - 0 1',
  'r2q1rk1/ppp2ppp/5B2/8/8/8/1P5P/6RK w - - 0 1',
  'r2q1rk1/ppp2ppp/5B2/8/8/8/P6P/6RK w - - 0 1',
  'r2q1rk1/ppp2ppp/5B2/8/8/8/8/6RK w - - 0 1',
  'r2q1rk1/ppp2ppp/5B2/8/8/8/8/6RK w - - 0 1',
  'r2q1rk1/ppp2ppp/5B2/8/8/8/8/6RK w - - 0 1',
  'r2q1rk1/ppp2ppp/5B2/8/8/8/8/6RK w - - 0 1',
...
const brFens1 = [
  ...
  '4r1k1/5ppp/8/8/8/8/5PPP/4R2K w - - 0 1',
...
const anastasiaFens = [
  ...
  '5r1k/4N1pp/8/7Q/8/4R3/8/7K w - - 0 1',
  '5r1k/4N1pp/8/7Q/8/4R3/6K1/8 w - - 0 1',
  '5r1k/4N1pp/8/7Q/8/4R3/7K/8 w - - 0 1',
  '5r1k/4N1pp/8/7Q/8/4R3/8/6K1 w - - 0 1',
  '5r1k/4N1pp/8/7Q/8/4R3/8/6K1 w - - 0 1',
  '5r1k/4N1pp/8/7Q/8/4R3/8/6K1 w - - 0 1',
...
hookFens2.forEach((fen, idx) => {
  ...
  ANASTASIA_HOOK.push(makeTactic({
    ...
    subtitle: 'Ra8# delivers checkmate supported by Knight and Pawn!',
    playerColor: 'w',
    tacticalGoal: 'Deliver Ra8# checkmate.',
    tacticalReward: 'checkmate',
    outcomeAdvantage: 'Checkmate 👑',
...
const smFens1 = [
  ...
  '5rk1/6pp/8/6N1/2Q5/8/8/7K w - - 0 1',
  '5rk1/6pp/8/6N1/2Q5/8/6K1/8 w - - 0 1',
  '5rk1/6pp/8/6N1/2Q5/8/7K/8 w - - 0 1',
  '5rk1/6pp/8/6N1/2Q5/8/8/6K1 w - - 0 1',
  '5rk1/6pp/8/6N1/2Q5/8/8/6K1 w - - 0 1',
  '5rk1/6pp/8/6N1/2Q5/8/8/6K1 w - - 0 1',
...
const smFens2 = [
  ...
  '6rk/6pp/7N/8/8/8/6K1/8 w - - 0 1',
  '6rk/6pp/7N/8/8/8/7K/8 w - - 0 1',
  '6rk/6pp/7N/8/8/8/8/6K1 w - - 0 1',
  '6rk/6pp/7N/8/8/8/8/6K1 w - - 0 1',
  '6rk/6pp/7N/8/8/8/8/6K1 w - - 0 1',
...
const promoPositions = [
  { fen: '3r2k1/4Pppp/8/8/8/8/8/4K3 w - - 0 1', move: 'e7d8q' },
  { fen: '3r2k1/4Pppp/8/8/8/8/8/3K4 w - - 0 1', move: 'e7d8q' },
  { fen: '3r2k1/4Pppp/8/8/8/8/8/2K5 w - - 0 1', move: 'e7d8q' },
  { fen: '3r2k1/4Pppp/8/8/8/8/8/1K6 w - - 0 1', move: 'e7d8q' },
  { fen: '3r2k1/4Pppp/8/8/8/8/8/K7 w - - 0 1', move: 'e7d8q' },
  { fen: '3r2k1/4Pppp/8/8/8/8/7P/4K3 w - - 0 1', move: 'e7d8q' },
  { fen: '3r2k1/4Pppp/8/8/8/8/6PP/4K3 w - - 0 1', move: 'e7d8q' },
  { fen: '3r2k1/4Pppp/8/8/8/8/5PPP/4K3 w - - 0 1', move: 'e7d8q' },
  { fen: '4r1k1/3P1ppp/8/8/8/8/8/4K3 w - - 0 1', move: 'd7e8q' },
  { fen: '2r3k1/3P1ppp/8/8/8/8/8/4K3 w - - 0 1', move: 'd7c8q' },
  { fen: '4r1k1/3P1ppp/8/8/8/8/8/3K4 w - - 0 1', move: 'd7e8q' },
  { fen: '2r3k1/3P1ppp/8/8/8/8/8/3K4 w - - 0 1', move: 'd7c8q' },
  { fen: '4r1k1/3P1ppp/8/8/8/8/8/2K5 w - - 0 1', move: 'd7e8q' },
  { fen: '2r3k1/3P1ppp/8/8/8/8/8/2K5 w - - 0 1', move: 'd7c8q' },
  { fen: '4r1k1/3P1ppp/8/8/8/8/8/1K6 w - - 0 1', move: 'd7e8q' },
  { fen: '2r3k1/3P1ppp/8/8/8/8/8/1K6 w - - 0 1', move: 'd7c8q' },
];

promoPositions.forEach(({ fen, move }, i) => {
  const num = String(i + 1).padStart(3, '0');
  const targetSq = move.slice(2, 4);
...
const kqMates = [
  { fen: '8/6Q1/8/8/8/5K2/8/7k w - - 0 1', move: 'g7g2' },
  { fen: '8/8/6Q1/8/8/5K2/8/7k w - - 0 1', move: 'g6g2' },
  { fen: '8/8/8/6Q1/8/5K2/8/7k w - - 0 1', move: 'g5g2' },
  { fen: '8/8/8/8/6Q1/5K2/8/7k w - - 0 1', move: 'g4g2' },
  { fen: '8/5Q2/8/8/8/4K3/8/5k2 w - - 0 1', move: 'f7f2' },
  { fen: '8/8/5Q2/8/8/4K3/8/5k2 w - - 0 1', move: 'f6f2' },
  { fen: '8/8/8/5Q2/8/4K3/8/5k2 w - - 0 1', move: 'f5f2' },
  { fen: '8/8/8/8/5Q2/4K3/8/5k2 w - - 0 1', move: 'f4f2' },
  { fen: '8/4Q3/8/8/8/3K4/8/4k3 w - - 0 1', move: 'e7e2' },
  { fen: '8/8/4Q3/8/8/3K4/8/4k3 w - - 0 1', move: 'e6e2' },
  { fen: '8/8/8/4Q3/8/3K4/8/4k3 w - - 0 1', move: 'e5e2' },
  { fen: '8/8/8/8/4Q3/3K4/8/4k3 w - - 0 1', move: 'e4e2' },
  { fen: '8/3Q4/8/8/8/2K5/8/3k4 w - - 0 1', move: 'd7d2' },
  { fen: '8/8/3Q4/8/8/2K5/8/3k4 w - - 0 1', move: 'd6d2' },
  { fen: '8/8/8/3Q4/8/2K5/8/3k4 w - - 0 1', move: 'd5d2' },
  { fen: '8/8/8/8/3Q4/2K5/8/3k4 w - - 0 1', move: 'd4d2' },
];

kqMates.forEach(({ fen, move }, idx) => {
  const i = idx + 16;
  const num = String(i + 1).padStart(3, '0');
  ENDGAME_CONVERSION.push(makeTactic({
    id: `puz_endgame_${num}`,
