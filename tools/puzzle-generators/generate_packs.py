...
FORKS = [
    ...
    {
        "id": "puz_fork_009",
        "fen": "r3k2r/ppp2ppp/2b5/8/8/8/PPP2PPP/R3K2R b KQkq - 0 1",
        "moves": ["c6c3", "e1e2", "c3a1"],
        "rating": 890,
        "ratingDeviation": 80,
        "themes": ["fork", "captures_checks_threats"],
        "primaryTheme": "fork",
...
with open(os.path.join(PACKS_DIR, "forks_pack.mjs"), "w") as f:
    f.write(f"export const FORK_DATA = {json.dumps(FORKS, indent=2)};\n")
print(f"Written forks_pack.mjs ({len(FORKS)} puzzles)")
